        ...
        <div>
            <div className={classes.root}>
                {!isMatch ?
                    ...
                    <>
                        <Paper onClick={(e) => {
                            window.location.replace("/#span1")
                        }} elevation={3} className={classes.webPaper} id='hello' >
                        ...
                        <Paper onClick={(e) => {
                            window.location.replace("/#span2")
                        }} elevation={3} className={classes.webPaper}>
                            <div className={classes.content} align="center">
                        ...
                        <Paper onClick={(e) => {
                            ...
                            <List >
                                <ListItem>
                                    <Icon style={{ fontSize: 10, color: "black" }} className={classes.paragraphContentWeb}>circle</Icon>
                                    <ListItemText primary="Access to previous purchases" />
                                </ListItem>
                                <ListItem>
                                    <Icon style={{ fontSize: 10, color: "black" }} className={classes.paragraphContentWeb}>circle</Icon>
                    ...
                    <>
                        ...
                        <Paper onClick={(e) => {
                            window.location.replace("/#span1")
                        }} elevation={3} className={classes.mobilePaper} >
                            <Grid container>
